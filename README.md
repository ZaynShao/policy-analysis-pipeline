...
聚焦 **L1 完整采集 + L2 高质量派生**,**L3 渲染(月报 / 决策卡片)不在本阶段范围**。
...
| 层 | 职责 | 落地 | 当前阶段 |
|---|---|---|---|
| **L1 采集** | 政策发现 / 抓取 / 入库 / 评论关联 | `scripts/l1_collect/` | ✓ 重点 |
| **L2 派生** | 实体 / 关系 / 评分 / 主题结晶 | `scripts/l2_derive/` | ✓ 重点 |
| L3 渲染 | 月报 / 决策卡片 | `scripts/l3_render/`(暂不维护) | — |
